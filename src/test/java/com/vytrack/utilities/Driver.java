...
public class Driver {
    ...
    public static WebDriver getDriver(){
        if(driverPool.get() == null){//if driver/browser was never opened + this way is Singleton Design Pattern
         ...
         */
            switch(browserType){
                case "chrome":
                    ...
                    driverPool.get().manage().timeouts().implicitlyWait(45, TimeUnit.SECONDS);
                    break;
                case "firefox":
